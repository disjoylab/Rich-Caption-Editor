...
public class SettingPanel : MonoBehaviour
{
    ...
    public GameObject InputObject_1;
        public TMP_InputField inputField_1; //TODO this should be an array
    ...
    {
        // Displays the current setting in the panel.
        ...
        //make objects visible based on setting type
        NameLabel.text = mySetting.GetSettingName();
        switch (mySetting.GetSettingType())
        {
    ...
    public void GetValues()
    {
        ...
        switch (mySetting.GetSettingType())
        {
            case SettingTypes.none:
                    ...
                    mySetting.SetSettingTypeFromString(dropdown_1.options[dropdown_1.value].text); 
                    StringValue = "";
